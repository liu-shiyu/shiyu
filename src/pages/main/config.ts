...
const info = {
  name: "刘士瑜",
  email: "liushiyu@163.com",
  qq: "1252906506",
  title: "静水流深",
  tag: ['95后', 'I T', '全栈开发', '理科生'],
  aboutContent: [
    '我是刘士瑜 .',
    '一名摄影爱好者、白日梦想家',
    '某知名视频站的不知名up主',
  ...
  log: [
    {data: '2020.11.05', readme: '注册域名yangyuhao.cn'},
    {data: '2020.11.05', readme: '域名完成ICP备案'},
    {data: '2020.12.05', readme: '网站Beta版原创界面上线'},
    {data: '2020.12.05', readme: '网站1.0版原创界面上线'},
    {data: '2020.12.05', readme: '网站加入响应式界面框架'},
  ]
}
